...
- 💼 Retirement planning'''
    ...
    'es': {
        ...
        'questions': [
            ...
            "¿Cuál es la diferencia entre un plan de pensiones 401k y un IRA?",
            "¿Debo pagar las deudas primero o invertir?",
            "¿Cuánto me puedo permitir gastar en vivienda?",
            ...
            "¿Qué es la estrategia de inversión periódica (DCA)?",
            "¿Necesito un asesor financiero?",
            "¿Cómo puedo crear un presupuesto desde cero?",
            "¿Cuál es la diferencia entre un plan de pensiones Roth y uno tradicional?",
            "¿Cómo puedo negociar mi salario?",
            "¿Qué seguros necesito realmente?"
        ],
...
- 💼 Planificació de jubilació'''
    ...
    'ko': {
        ...
        'questions': [
            ...
            "빚을 먼저 갚을까요, 투자를 먼저 할까요?",
            "얼마 정도의 집을 살 수 있을까요?",
            "복리 이자가 무엇이고 어떻게 작동하나요?",
            "신용점수를 어떻게 올릴 수 있나요?",
            "주식과 채권의 차이점은 무엇인가요?",
            "은퇴를 위해 얼마나 저축해야 하나요?",
            "정액 분할 투자법(달러 코스트 애버리징)이 무엇인가요?",
            "재정 상담사가 필요한가요?",
            "처음부터 예산을 어떻게 세우나요?",
            "로스 IRA와 일반 IRA의 차이점은 무엇인가요?",
            "급여 협상을 어떻게 해야 하나요?",
            "정말 필요한 보험은 무엇인가요?"
        ],
